...
## 2026-07-06
- [トークンとは何か(LLMの処理単位と料金・コンテキストウィンドウの関係)](topics/part01-ai-llm-basics/token-basics.md): 新規執筆(トークンの仕組みと料金・コンテキストウィンドウの関係)
- [ChatGPTの初期設定とカスタム指示の書き方](topics/part02-chatgpt-basics/chatgpt-custom-instructions.md): 新規執筆(カスタム指示の設定手順・記入例・メモリ機能との使い分け)
- [ハルシネーションの仕組みと実務での対策](topics/part03-risk-security/hallucination-and-countermeasures.md): 新規執筆(ハルシネーションの原因と実務対策)
- [Zero-shot・Few-shot・Chain-of-Thoughtプロンプティングの使い分け](topics/part04-prompt-engineering/zero-shot-few-shot-cot-prompting.md): 新規執筆(3手法の比較と使い分け、推論モデル時代のCoTの要不要も整理)
- [GPTsのナレッジファイル活用法](topics/part05-gpts-customization/gpts-knowledge-files.md): 新規執筆(ナレッジファイルの仕組み・アップロード手順・対応形式と上限・精度向上のコツ)
- [ChatGPTのデータ分析機能(Advanced Data Analysis)の使い方](topics/part06-data-analysis/chatgpt-data-analysis.md): 新規執筆(Advanced Data Analysisの使い方とプラン別利用可否・上限)
- [NotebookLMの基本と使い方](topics/part07-other-llm-tools/notebooklm-basics.md): 新規執筆(NotebookLMの仕組み・使いどころ・音声概要の作り方)
- [Function Calling(Tool Calling)の基本](topics/part08-api-development/function-calling-basics.md): 新規執筆(Function Callingの仕組みと業務システム連携の実例)
