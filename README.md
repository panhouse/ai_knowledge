...
(Part 1〜13は教科書、Part 14〜17はカタログ)のトピックを1つずつ書き上げ、常に最新に保ちます。
...
| [Part 17](topics/part17-overseas-ai-companies/_index.md) | 海外AI企業マップ | 基盤モデル・フロンティアAI系、AI半導体・インフラ系、業務ドメイン特化ツール系(+未分類の受け皿) |

## 仕組み

1. 毎朝9時(JST)にルーティンが知識体系の未執筆トピックから最大10件を選定
2. Web検索(日英)で裏取り・最新情報を確認しながら、教材品質のガイドページを執筆
3. 業種別の活用事例は Part 14、職種別の活用事例は Part 15、国内AI企業の一覧は Part 16、
   海外AI企業の一覧は Part 17 に整理(体系に収まらないテーマはそれぞれ末尾の「その他・未分類」へ一旦集約)
