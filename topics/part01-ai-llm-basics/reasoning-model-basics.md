...
|---|---|---|---|
| OpenAI(ChatGPT) | GPT-5.5 Instant | GPT-5.5 Thinking(Medium/High/Extra High) | モデルピッカーで切り替え。詳細は[ChatGPTのモデル一覧と使い分け](../part02-chatgpt-basics/chatgpt-model-lineup.md) |
...
| ツール | 切り替え場所 | 補足 |
|---|---|---|
| ChatGPT | 画面左上のモデル名をクリック→「Instant」「Thinking」「Pro」から選択。「Configure」から思考の深さ(Medium/High/Extra High)を調整 | 詳細な手順・プラン別の利用可否は[ChatGPTのモデル一覧と使い分け](../part02-chatgpt-basics/chatgpt-model-lineup.md)を参照 |
...
- [Chain-of-Thought(CoT)プロンプティング](../part04-prompt-engineering/chain-of-thought-prompting.md)
- [ChatGPTのモデル一覧と使い分け](../part02-chatgpt-basics/chatgpt-model-lineup.md)
