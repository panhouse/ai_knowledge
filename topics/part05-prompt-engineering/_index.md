---
title: "Part 5: プロンプトエンジニアリング"
part: 5
---

# Part 5: プロンプトエンジニアリング

## 章構成(分類の地図)

### 第1章 基本原則
- 構成要素、Markdown活用、テンプレート化、明確な指示
- System Prompt(システムプロンプト)の役割と書き方

### 第2章 例示と誘導
- Zero-shot / Few-shot、ロールプロンプティング

### 第3章 思考を引き出す手法
- CoT、ToT、自己整合性(Self-Consistency)

### 第4章 エージェント的手法
- ReAct、メタプロンプティング、タスク分解

### 第5章 評価と改善
- 点数法(ルーブリック)、プロンプトの検証・反復改善
