...
**2026年9月10日にプレビューから正式提供(GA)へ移行**しており、業務の基幹作業に組み込む
ハードルは以前より下がっている。
...
2026年9月時点で、Gemini 系(Gemini 3.8 Flash / 3.7 Flash / 3.6 Flash / 3.1 Pro)に加えて
Claude Sonnet / Opus 4.6、gpt-oss-120b が選べる(無料のIndividualプランでも同じモデルにアクセスできる)。
...
| 無料枠でエージェント開発を試したい | Google Cloud経由の請求・調達フローに統一したい(→Organization) |
...
- **2026年9月10日にGAへ移行したが、個別機能はなお発展途上。** 本体はプレビューを終えたが、
  新機能(スケジュール実行、Documentsセクションなど)は追加され続けているため、
  業務の基幹作業に組み込む前に必要な機能が安定版かを確認する
...
### 2026-09-18: GA(正式提供)移行とモデルカタログ更新を反映
- **内容**: 2026年9月10日にAntigravityがプレビューから正式提供(GA)へ移行したことを反映し、
  「業務での安定稼働はまだプレビュー」としていた注意点を「本体はGAだが個別機能は発展途上」に修正。
  無料のIndividualプランを含め選択できるモデルにGemini 3.8 Flash・3.7 Flashが追加されたことを反映
- **出典**: [Google Antigravity: Pricing](https://antigravity.google/pricing)
