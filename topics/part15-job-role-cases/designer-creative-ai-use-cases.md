...
tags: [デザイナー, UI/UXデザイン, Figma AI, Adobe Firefly, ムードボード, 著作権, ブランド一貫性, デザインレビュー, 導入事例]
created: 2026-07-17
updated: 2026-09-26
---
...
### IBM(IT・コンサルティング、グローバル大企業) — 対象業務: ブランドキャンペーンの画像アセット制作
- **導入形態**: 専用SaaS導入
- **段階**: 全社展開(マーケティング部門・コンサルティング部門横断)
- **やったこと**: ブランドキャンペーン「Let's Create」の画像アセット制作にAdobe Firefly(Adobe Express・Photoshop・Experience Manager Assets経由)を導入。簡単なテキストプロンプトから複数のキャンペーン用ビジュアルとバリエーションを生成するフローに組み込んだ。
- **効果**: 数分で200アセット・1,000種類以上のバリエーションを生成、施策のエンゲージメントが従来比26倍、生産性は10倍に向上すると見込む(2024年3月時点、Adobe公式ブログでのベンダー公表・IBM担当者コメント引用)
- **学べること**: バリエーション量産が必要なキャンペーン制作は、生成AI導入で最も早く効果が出る業務領域である
- **出典**: [Adobe Blog(日本版)「IBMの事例」](https://blog.adobe.com/jp/publish/2024/03/19/cc-design-ibm-reimagines-content-creation-digital-marketing-adobe-firefly-generative-ai) / 最終確認日: 2026-09-26

### 株式会社アドバン(Web制作・クリエイティブ事業、福岡・従業員約50名) — 対象業務: 画像素材の選定・加工、デザインバリエーション作成
- **導入形態**: 専用SaaS導入
- **段階**: 部門展開(クリエイティブ事業部)
- **やったこと**: Photoshopの生成拡張・生成塗りつぶし、Illustratorの生成再配色、テキストからの画像生成など、Adobe Fireflyの各機能を素材の検索・加工・不要オブジェクト除去・背景補正の実務フローに組み込んだ。
- **効果**: ストック素材購入などのコストを約50%削減、素材の選定・加工にかかる時間を半分以下に短縮(2024年3月時点、Adobe公式ブログでのベンダー公表・同社クリエイティブ事業部社員のコメント引用)
- **学べること**: 中小規模の制作会社でも、素材加工という定型作業から着手すればコスト効果を出しやすい
- **出典**: [Adobe Blog(日本版)「株式会社アドバンの事例」](https://blog.adobe.com/jp/publish/2024/03/06/cc-firefly-advan) / 最終確認日: 2026-09-26

### Monks(グローバル・クリエイティブ/マーケティングエージェンシー、S4 Capital傘下) — 対象業務: 3Dアセット制作・広告バナーのバージョン展開
- **導入形態**: 専用SaaS導入
- **段階**: 全社展開
- **やったこと**: Adobe FireflyとSubstance 3Dを組み合わせ、3Dアセット制作および多チャネル・多デバイス向け広告バナーの大量バージョン展開の制作フローに組み込んだ。
- **効果**: 3Dアセット制作が従来比70%高速化、270種類のバナーバリエーションを(従来は最大4週間かかっていた作業を)1日で生成し96%の高速化を達成(2024年時点、Adobe公式サイトでのベンダー公表の顧客事例)
- **学べること**: 大量のクリエイティブバリエーションを要する広告制作は、生成AIによる時間短縮効果が定量化しやすい
- **出典**: [Adobe Business「Monks case study」](https://business.adobe.com/customer-success-stories/monks-case-study.html) / 最終確認日: 2026-09-26

### 事例から見える傾向

3件とも「ベンダー(Adobe)公表の顧客事例」という同じ性質の一次情報だが、企業規模(グローバル大企業〜従業員50名の地方制作会社まで)を問わず、効果が最初に出るのは「素材加工・バリエーション量産」という定型的な制作工程である点が共通している。ブランディングの企画やコンセプトメイキングそのものより、既存デザインのコピー・調整・展開作業(色違い・サイズ違い・チャネル別バナーなど)に生成AIを組み込むケースが先行しており、時間短縮率(50〜96%)という形で定量化されやすい。UI/UXデザイン領域(Figma AI等)での、数値効果付き・裏取り可能な実名事例は本ページ執筆時点では見つかっておらず、現時点の事例はグラフィックデザイン・ブランドクリエイティブ領域に偏っている。
...
### 2026-09-26: 導入事例カタログを新設し、IBM・株式会社アドバン・Monksの3事例を追加
- **内容**: 「使いどころ・使い分け」の後に「## 導入事例カタログ」を新設。Adobe Fireflyを使ったブランドキャンペーン制作(IBM)、Web制作会社の素材加工コスト削減(株式会社アドバン)、クリエイティブエージェンシーの3Dアセット・広告バナー量産(Monks)の3件を、いずれもAdobe公式の顧客事例(ベンダー公表)として実名・数値付きで追加した。UI/UXデザイン領域(Figma AI等)の裏取り可能な実名事例は今回見つからなかった旨を明記した
- **出典**: [Adobe Blog(日本版)「IBMの事例」](https://blog.adobe.com/jp/publish/2024/03/19/cc-design-ibm-reimagines-content-creation-digital-marketing-adobe-firefly-generative-ai)、[Adobe Blog(日本版)「株式会社アドバンの事例」](https://blog.adobe.com/jp/publish/2024/03/06/cc-firefly-advan)、[Adobe Business「Monks case study」](https://business.adobe.com/customer-success-stories/monks-case-study.html)
