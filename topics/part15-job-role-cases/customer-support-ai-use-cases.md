...
### ソフトバンク(ワイモバイル・通信キャリア) — 対象業務: 暗証番号照会の音声自動応対
- **導入形態**: 内製(自律思考型生成AIプラットフォームを自社開発)
- **段階**: 部門展開(2025年8月下旬より運用開始)
- **やったこと**: ワイモバイルのカスタマーサポートに自律思考型の生成AIを導入し、暗証番号の照会業務の一部を音声対応で自動化。AIが顧客の発話から文脈・意図を理解し、自律的に質問や確認を重ねながら対話する仕組みを構築した。
- **効果**: 数値公表なし。目的として「顧客待ち時間の短縮」「応対品質の均質化」「コールセンター業務の効率化」を掲げている(2025年11月時点、自社公表)。得られた知見は同社が提供するAIエージェントサービス「X-Ghost」(Gen-AX社)にも今後活用予定
- **学べること**: 定型的な照会業務から段階的に自動化範囲を広げ、得た知見を自社の外販AIサービスにも還元する「社内実証→製品化」の展開パターンが見える
- **出典**: [ソフトバンク プレスリリース「"ワイモバイル"のカスタマーサポートに自律思考型生成AIを導入」](https://www.softbank.jp/corp/news/press/sbkk/2025/20251107_01/) / 最終確認日: 2026-09-23

### KDDI(通信キャリア・お客さまセンター) — 対象業務: au PAY・auPAYカード・Pontaポイント関連の問い合わせ対応
- **導入形態**: 内製(自社お客さまセンターの応対実績をもとに独自開発)
- **段階**: 部門展開(2026年3月10日運用開始、2026年度内をめどにauサービス全般へ拡大予定)
- **やったこと**: お客さまセンターの応対実績を基に開発した自律型AIエージェントによる問い合わせ対応を、au PAY・auPAYカード・Pontaポイント関連の問い合わせから開始。複雑な問い合わせ内容の意図を認識し、追加質問や内容確認をしながら解決方法を案内する。
- **効果**: 具体的な効果数値は本稿執筆時点(2026年3月)で未公表。背景として、同社お客さまセンターは月間約200万件の問い合わせを受け、うち55%以上がデジタルチャネルで応対されている(2026年3月時点、自社公表)
- **学べること**: 大規模コールセンターでは一気に全対応をAI化せず、決済・ポイント関連という切り分けやすい問い合わせ群から段階導入し、扱う範囲を計画的に広げる進め方が実務的
- **出典**: [KDDI ニュースルーム「お客さまセンターの応対実績を基に独自開発した自律型AIエージェントによるお問い合わせ対応を開始」](https://newsroom.kddi.com/news/detail/kddi_nr-951_4359.html) / 最終確認日: 2026-09-23

### アフラック生命保険(生命保険・国内生保大手) — 対象業務: コールセンターの電話応対(住所・名義変更等の手続き)
- **導入形態**: 内製(米OpenAIと提携し、AIアバターによる音声応対システムを共同開発)
- **段階**: 部門展開(2025年8月より住所・名義変更やサービス案内から順次開始)
- **やったこと**: OpenAIと提携し、オペレーターのアバター(分身)が音声で顧客対応するシステムを開発。2025年内に住所変更手続きをAIのみで完結させることを目指し、将来的にはコールセンター業務全体をAIで代替する計画。投資額は170億円
- **効果**: 2031年までにコールセンター担当者(約1,600人)を半減し、人件費などを500億円削減できる見通し(2025年6月時点、日本経済新聞報道による計画段階の数値であり、実績値ではない)。国内生保では初の大規模自動化とされる
- **学べること**: 「一次対応の効率化」にとどまらず、要員計画・投資額まで含めた中期経営計画レベルでAI活用を位置づける保険業界特有の踏み込み方が読み取れる。数値はあくまで計画時点の見通しであり、実績として引用しないよう注意する
- **出典**: [日本経済新聞「アフラック、AIで日本のコールセンター人員5割減 OpenAIと提携」](https://www.nikkei.com/article/DGXZQOUB16BO80W5A610C2000000/) / 最終確認日: 2026-09-23

### 事例から見える傾向

いずれも大手・準大手企業が自社データを学習させた内製・共同開発型のAIエージェントで、いきなり全対応を自動化するのではなく「暗証番号照会」「決済・ポイント関連の問い合わせ」「住所変更手続き」など、範囲を限定した領域から段階的に対応範囲を広げる進め方が共通している。定量的な成果(解決率・コスト削減額)を導入直後に公表する例はまだ少なく、アフラックのように投資額・要員計画まで踏み込んで開示するケースは現時点では珍しい部類に入る。
...
- **内容**: 「使いどころ・使い分け」の後に「導入事例カタログ」節を新設。ソフトバンク(ワイモバイル、暗証番号照会の音声自動応対)、KDDI(お客さまセンター、au PAY・auPAYカード・Pontaポイント問い合わせ対応)、アフラック生命保険(OpenAIと提携したAIアバター音声応対)の3社の実名事例をcase-card形式で追加
- **出典**: [ソフトバンク プレスリリース「"ワイモバイル"のカスタマーサポートに自律思考型生成AIを導入」](https://www.softbank.jp/corp/news/press/sbkk/2025/20251107_01/)
- **出典**: [KDDI ニュースルーム「お客さまセンターの応対実績を基に独自開発した自律型AIエージェントによるお問い合わせ対応を開始」](https://newsroom.kddi.com/news/detail/kddi_nr-951_4359.html)
- **出典**: [日本経済新聞「アフラック、AIで日本のコールセンター人員5割減 OpenAIと提携」](https://www.nikkei.com/article/DGXZQOUB16BO80W5A610C2000000/)
