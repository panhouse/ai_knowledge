---
title: "Part 14: 業種別 生成AI活用事例"
part: 14
---

# Part 14: 業種別 生成AI活用事例

各業種における生成AIの活用事例を、業種ごとに整理して集約する場所。
Part 1〜13 が「概念・手法の教科書」であるのに対し、ここは
「その業種で実際にどう使われているか」の事例カタログとして育てる。

- 事例は「どの業務で・どのツールで・どんな効果が出たか」を具体で書く
- 1つの事例が複数業種にまたがる場合は、主となる業種の章に置き、他章から相互リンクする
- どの業種にも当てはまらない/分類が難しいテーマは、末尾の「その他・未分類」に一旦置き、
  内容が育ったら該当パートや業種の章へ移動してよい
- 定期的(月1回程度)に見直し、体系への移動や新しい章としての昇格をユーザーに提案する

## 書き方の指針(このパート固有)

雛形は `templates/topic-page.md`。章の単位は業種、ページの単位は原則「1業種1ページ」とする。

このパートは教科書ではなく**事例カタログ**である。一般論の「製造業でもAIが使えます」で
終わらせず、**実名企業が・どの業務で・何を使い・どうなったか**を書く。

### 導入事例カタログ

各ページに「## 導入事例カタログ」の節を置き、**実名企業の事例を1事例=1カード**で書く。
カードの書式・必須メタデータ(導入形態/段階/効果の時点と公表主体/最終確認日/出典)は
**`templates/case-card.md` が正**。Part 15(職種別)と共通の書式を使う。

- **件数**: 新規執筆は実在事例 **5件以上**、既存ページへの事例追加は **3件以上**
- 件数を満たせない業種は無理に埋めず次回に回す(**水増し禁止**。想定シナリオで件数を稼がない)
- 業界全体の動きを俯瞰する「主要プレイヤーの取り組みマップ」(表形式)を併用してよい。
  ただし表の各行にも**企業名・時期・効果の出典**を伴わせ、カードと同じ厳しさで書く
- 既存ページ(この指針より前に書かれたもの)は、事例追加・最新化の対象になったタイミングで
  「導入事例カタログ」節に寄せていく。既存の「代表事例の詳細」節は、
  内容を保ったままカード書式に整えるか、カタログ節の下に移す
- Part 15(職種別)と同じ事例が候補になったときの置き場所は `templates/case-card.md` の
  「Part 14 と Part 15 の重複の扱い」に従う
- ツールの提供元企業に触れるときは深掘りせず、Part 16(国内)・Part 17(海外)へリンクする
...
### 第2章 小売・流通・EC
- 商品説明生成、需要予測、接客・カスタマーサポート

### 第3章 金融・保険
- 融資・審査、コンプライアンス、レポート作成

### 第4章 医療・ヘルスケア
- 問診・記録作成、文献調査、患者向け説明

### 第5章 建設・不動産
- 図面・書類作成、物件情報生成、契約チェック

### 第6章 IT・情報通信
- 開発支援、ドキュメント生成、社内ヘルプデスク

### 第7章 メディア・広告・エンタメ
- コンテンツ制作、コピー生成、リサーチ・企画

### 第8章 教育
- 教材作成、個別指導、採点・フィードバック

### 第9章 公共・自治体
- 住民対応、文書作成、政策リサーチ

### 第10章 物流・運輸
- 配送最適化、問い合わせ対応、マニュアル整備

### 第11章 士業・専門サービス
- 法律・会計・コンサルでの調査・ドラフト作成

### 第12章 その他・未分類
- 上記の業種に当てはまらない事例・分類が難しいテーマの一時受け皿
...
- [特許事務所・弁理士事務所における生成AI活用事例](patent-attorney-firm-ai-use-cases.md)
- [公共・自治体における生成AI活用事例](public-sector-ai-use-cases.md)
- [郵便・信書便業界における生成AI活用事例](postal-service-industry-ai-use-cases.md)
...
- [NPO・非営利団体における生成AI活用事例](npo-nonprofit-ai-use-cases.md)
...
- [出版・印刷業における生成AI活用事例](publishing-printing-ai-use-cases.md)
...
- [警備業界における生成AI活用事例](security-services-industry-ai-use-cases.md)
...
- [石油製品・LPガス販売業界における生成AI活用事例](petroleum-lpgas-retail-ai-use-cases.md)
...
- [婚活・マッチングサービス業界における生成AI活用事例](matchmaking-dating-industry-ai-use-cases.md)
...
- [太陽光発電・再生可能エネルギー事業における生成AI活用事例](solar-renewable-energy-ai-use-cases.md)
- [害虫駆除・特殊清掃業界における生成AI活用事例](pest-control-specialty-cleaning-industry-ai-use-cases.md)
- [コンビニエンスストア業界における生成AI活用事例](convenience-store-industry-ai-use-cases.md)
- [ホームセンター(DIY小売)業界における生成AI活用事例](home-center-diy-retail-ai-use-cases.md)
- [自動車整備・鈑金業界における生成AI活用事例](auto-repair-bodyshop-industry-ai-use-cases.md)
- [語学学校業界における生成AI活用事例](language-school-industry-ai-use-cases.md)
- [フードデリバリー・宅配代行業界における生成AI活用事例](food-delivery-industry-ai-use-cases.md)
- [造園・エクステリア業界における生成AI活用事例](landscaping-exterior-industry-ai-use-cases.md)
- [測量・ドローン点検業界における生成AI活用事例](surveying-drone-inspection-industry-ai-use-cases.md)
- [広告代理店業界における生成AI活用事例](advertising-agency-industry-ai-use-cases.md)
- [証券・資産運用業界における生成AI活用事例](asset-management-securities-industry-ai-use-cases.md)
- [サイバーセキュリティ業界における生成AI活用事例](cybersecurity-industry-ai-use-cases.md)
- [大学・高等教育機関における生成AI活用事例](higher-education-industry-ai-use-cases.md)
- [医療機器製造業における生成AI活用事例](medical-device-manufacturing-ai-use-cases.md)
...
- [イベント・展示会業界における生成AI活用事例](event-exhibition-industry-ai-use-cases.md)
- [パチンコ・アミューズメント業界における生成AI活用事例](amusement-pachinko-industry-ai-use-cases.md)
- [リフォーム・リノベーション業界における生成AI活用事例](home-renovation-remodeling-ai-use-cases.md)
- [レンタル・リース業界における生成AI活用事例](rental-leasing-industry-ai-use-cases.md)
- [化粧品業界における生成AI活用事例](cosmetics-industry-ai-use-cases.md)
- [家具・インテリア業界における生成AI活用事例](furniture-interior-industry-ai-use-cases.md)
- [鉱業・資源開発における生成AI活用事例](mining-resource-industry-ai-use-cases.md)
