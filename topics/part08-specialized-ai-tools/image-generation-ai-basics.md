...
soft navy and yellow color palette, clean lines, no text --ar 16:9 --stylize 150 --v 8.2
```
...
| `--v 8.2` | 使用するモデルのバージョン指定(2026年6月にV7からV8.1へ、7月24日にV8.1からV8.2へデフォルトが切り替わった。2026年8月時点の最新はV8.2。直前のV8.1も引き続き指定可能) |
...
| ツール | プラン | 料金 | 内容の目安 |
|---|---|---|---|
| Midjourney | Basic | 月額$10(年払い相当$8) | Fast GPU時間 3.3時間/月(V8.2の標準生成は1枚あたり目安0.8 GPU分) |
...
| Google Gemini | AI Ultra | 月額$99.99(エントリー、Pro比約5倍の利用上限)〜$199.99(上位、Pro比約20倍) | さらに高い利用上限、開発者向け機能を含む上位プラン(2026年5月のI/Oで旧単一$249.99プランを2段階に再編) |
| Nano Banana Pro API(Gemini 3 Pro Image) | 従量課金 | 1枚あたり標準処理で約$0.134(1K/2K)〜$0.24(4K)、バッチ処理では約$0.067(1K/2K)〜$0.12(4K) | 高精度・高解像度の量産・API組み込み向け |
...
- **出典**: [How to Use Midjourney in 2026: Plans, Prompts, and V8.1 | AI Weekly](https://aiweekly.co/learning-ai/generative-ai/how-to-use-midjourney)、[Midjourney V8.2: Changes and Practical Creator Guide | Quasa](https://quasa.io/media/midjourney-v8-2-what-changed-and-how-creators-should-use-it)、[Midjourney V8.2 Is Here. What's New and Is It Better Than V8.1? | RunThePrompts](https://runtheprompts.com/resources/midjourney-info/midjourney-v8-2-whats-new-and-is-it-better-than-v8-1/)、[Nano Banana Pro: Gemini 3 Pro Image model from Google DeepMind](https://blog.google/innovation-and-ai/products/nano-banana-pro/)、[Nano Banana Pro API Pricing: 1K, 2K & 4K Costs | AI Free API](https://www.aifreeapi.com/en/posts/nano-banana-pro-pricing)、[Google Imagen 4 API shutdown window: August 17, 2026 | Kingy AI](https://kingy.ai/ai-launch-tracker/google-will-shut-down-three-imagen-4-api-models-august-17/)、[Migrate from Imagen to a Gemini Image model ("Nano Banana") | Firebase AI Logic](https://firebase.google.com/docs/ai-logic/imagen-models-migration)、[Google AI Plans: Free vs Plus vs Pro vs Ultra 2026 | Digital Applied](https://www.digitalapplied.com/blog/google-ai-plans-free-plus-pro-ultra-2026)、[The Google AI Ultra plan now starts at $100 a month | Engadget](https://www.engadget.com/2176060/the-google-ai-ultra-plan-now-starts-at-100-a-month/)、[Adobe Firefly 2026 Guide: Features, Pricing, Models & How to Use It | AI Tools DevPro](https://aitoolsdevpro.com/ai-tools/adobe-firefly-guide/)、[Adobe Firefly Pricing 2026 | G2](https://www.g2.com/products/adobe-firefly/pricing)、[Stable Diffusion News 2026: SD4 Launches, the Company Survives, and Flux Rises](https://thebriefscript.com/stable-diffusion-news-2026/)、[Black Forest Labs Releases FLUX 3: A Multimodal Flow Model for Image, Video, Audio and Robot Action Prediction | MarkTechPost](https://www.marktechpost.com/2026/07/26/black-forest-labs-releases-flux-3-a-multimodal-flow-model-for-image-video-audio-and-robot-action-prediction/)、[Black Forest Labs launches FLUX 3 ... but in limited release to start | VentureBeat](https://venturebeat.com/technology/black-forest-labs-launches-flux-3-capable-of-generating-images-and-20-second-video-with-audio-but-in-limited-release-to-start)、[Ideogram V4 Pricing: API Tiers, Subscriptions, Free Access | kie.ai](https://kie.ai/blog/ideogram-v4-pricing)、[Grok Imagine Image 2.0: How xAI's New AI Model Is Different From Others | ETV Bharat](https://www.etvbharat.com/en/technology/xai-grok-imagine-image-2-launch-features-enn26081002584)、[GPT Image 2 Pricing Breakdown: How Much Does It Actually Cost? (2026) | nemovideo](https://www.nemovideo.com/blog/gpt-image-2-pricing-breakdown)
