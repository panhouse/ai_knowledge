...
- **Go**: Instant中心。Thinkingは回数を絞って利用可
...
プランごとの料金・機能・ガバナンスの全体像は[ChatGPTのプラン比較](chatgpt-plan-comparison.md)を参照。本ページはモデル選びに絞って解説する。
...
- **「常に一番賢いモデルを使えばよい」は誤り**: Thinking/Proは待ち時間が長く、利用回数の上限も早く消費する。日常的なやり取りはInstantのままで十分なことが多い
