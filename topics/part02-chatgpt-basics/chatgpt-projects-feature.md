...
Claudeのプロジェクト機能の詳細は「[Claude(Anthropic)の基本](../part07-other-llm-tools/claude-basics.md)」、カスタムGPTの作り方は「[GPTs(カスタムGPT)作成の基本](../part05-gpts-customization/gpts-creation-basics.md)」を参照。
