...
[AIが扱いやすいデータ形式](../part06-data-analysis/ai-friendly-data-formats.md)で触れたとおり、JSONは「API連携やDBとの受け渡しなど、機械的処理をさせたいとき」に向く形式である。本ページで扱うJSONモード/Structured Outputsは、その「AIの出力を機械処理しやすいJSONにする」という要求を、プロンプトでの工夫ではなくAPIの機能として確実に実現する手段だと位置づけられる。
